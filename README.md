...
This repository contains the source code used in the computational experiments of the paper: **Bilevel Mixed-Integer Linear Program with Binary Tender
** (available on arXiv [https://arxiv.org/abs/2509.02370]).
